...
const Hero = () => {
  ...
  return (
    <section className="relative w-full px-5 py-10 text-white overflow-hidden">
      ...
      {/* Content */}
      <div className="relative w-[100%] md:w-[87%] p-2 md:p-0 mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10 py-10 md:py-0">

        {/* Kolom kiri */}
        <div className="flex flex-col gap-6 text-center md:text-left basis-1/2">
          <p className="leading-relaxed font-bold text-[16px] uppercase text-[#daaf22]">
        ...
        <div className="flex justify-center items-center basis-1/2 ">
          <div className="relative flex justify-center items-center mb-[-40px] w-full">
            <Image
              ...
              width={600}
              height={600}
              className="object-contain w-auto max-w-[100%] md:max-w-[80%] h-auto"
              priority
            />
          </div>
        </div>
